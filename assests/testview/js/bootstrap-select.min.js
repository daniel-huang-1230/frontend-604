(function(root, factory) {
  ...
  (function($) {
    ...
    var valHooks = { useDefault: !1, _set: $.valHooks.select.set };
    $.valHooks.select.set = function(elem, value) {
      if (value && !valHooks.useDefault) $(elem).data("selected", !0);
    ...
    $.fn.triggerNative = function(eventName) {
      ...
      if (el.dispatchEvent) {
        if (EventIsSupported) {
          event = new Event(eventName, { bubbles: !0 });
        } else {
    ...
    Selectpicker.prototype = {
      ...
      createLi: function() {
        ...
        $selectOptions.each(function(index) {
          ...
          if (isOptgroup && $this.data("divider") !== !0) {
          ...
          } else if ($this.data("divider") === !0) {
            _li.push(generateLI("", index, "divider"));
          } else if ($this.data("hidden") === !0) {
            prevHiddenIndex = $this.data("prevHiddenIndex");
            $this
              .next()
              .data(
      ...
      liHeight: function(refresh) {
        if (!refresh && (this.options.size === !1 || this.sizeInfo)) return;
          ...
          var getSize = function() {
            var minHeight,
              ...
              lisVisible = Array.prototype.filter
                ? Array.prototype.filter.call(lis, hasClass("hidden", !1))
                : that.$lis.not(".hidden"),
              optGroup = Array.prototype.filter
                ? Array.prototype.filter.call(
                    lisVisible,
                    hasClass("dropdown-header", !0)
                  )
      ...
      clickListener: function() {
        ...
        this.$element.on("shown.bs.select", function() {
          if (!that.options.liveSearch && !that.multiple) {
            ...
            if (typeof selectedIndex !== "number" || that.options.size === !1)
              return;
            var offset =
        ...
        this.$menuInner.on("click", "li a", function(e) {
          ...
          if (!that.isDisabled() && !$this.parent().hasClass("disabled")) {
            ...
            if (!that.multiple) {
              ...
              $this.blur();
              if (maxOptions !== !1 || maxOptionsGrp !== !1) {
                var maxReached =
                ...
                if (
                  ...
                  if (maxOptions && maxOptions == 1) {
                    ...
                    $optgroup.find("option:selected").prop("selected", !1);
                    $option.prop("selected", !0);
